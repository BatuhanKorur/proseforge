...
export default function Loader({ className, svgClass }: {
  className?: string
  svgClass?: string
}) {
  return (
    <div className={cn('flex items-center justify-center', className)}>
      <svg fill="hsl(228, 97%, 42%)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={cn('size-10', svgClass)}>
